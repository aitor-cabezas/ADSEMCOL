...
function SmoothVortex(; hp::Float64=1.0, FesOrder::Int=5, tf::Float64 = 0.1, 
    ...
    epsilon::Float64=0.0, nu::Float64=0e-6, beta::Float64=0.0, kappa_rho_cv::Float64=0e-6, vortex_st::Float64=1.11,u_inf::Float64=1.0,v_inf::Float64=0.0,gamma::Float64=1.4,a_infty::Float64=sqrt(gamma),rho_infty::Float64=1.0,R::Float64=1.0,sigma::Float64=1.0,
