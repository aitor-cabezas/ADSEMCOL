...
try
    ...
    elseif ProblemName=="SmoothVortex"
        ...
        SmoothVortex(TMSName=TMSName,RoWMethod=RoWMethod,RKMethod=RKMethod,tf=tf,Deltat0=Deltat0,TolT=TolT,hp=hp,TolS=TolS,vortex_st=vortex_st,a_infty=a_infty,u_inf=u_inf,gamma=gamma,TimeAdapt=TimeAdapt,SC=SC,SaveRes=true;SpaceAdapt=false,hp=0.1,FesOrder=8)
