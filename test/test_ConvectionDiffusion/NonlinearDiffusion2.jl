...
#     end
    ...
    function epsilon(t::Float64,x::Vector{Matrix{Float64}},u::Vector{Matrix{Float64}})
    ...
    function depsilon_du(t::Float64,x::Vector{Matrix{Float64}},u::Vector{Matrix{Float64}})
    ...
    function Q(t::Float64,x::Vector{Matrix{Float64}},u::Vector{Matrix{Float64}})
        ...
        DTm   = epsilon(t,x,H(t,x))[1]
        dDTm  = depsilon_du(t,x,H(t,x))[1]
...
#                             FWt11((t,x)->dQ_du(t,x)) )
    ...
    ProblemData = SCD(
        FWt21((t,x,u)->a(t,x,u)),
        FWt21((t,x,u)->epsilon(t,x,u)),
        FWt21((t,x,u)->Q(t,x,u)),
        FWt21((t,x,u)->da_du(t,x,u)),
        FWt21((t,x,u)->depsilon_du(t,x,u)),
