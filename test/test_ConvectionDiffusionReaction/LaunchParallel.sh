...
#SBATCH --array=50-50,99-99,148-148%3
...
ARGS=$( awk 'NR=='$SLURM_ARRAY_TASK_ID 'test/test_ConvectionDiffusionReaction/'$SLURM_JOB_NAME.lp )

#Call Julia:
# srun --exclusive julia -t$SLURM_CPUS_PER_TASK test/test_ConvectionDiffusionReaction/Launch.jl $ARGS
srun --exclusive julia test/test_ConvectionDiffusionReaction/Launch.jl $ARGS
